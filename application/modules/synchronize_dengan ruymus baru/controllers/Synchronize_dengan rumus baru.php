...
class Synchronize extends MY_Controller
{
    ...
    public function sync()
    {
        ...
        $id_instansi        = 91;//$this->input->post('id_instansi');
...
$total_realisasi_bulanan_bt_bbk += $realisasi_keuangan_bulanan['realisasi_bt_bbk'];
        ...
        $data_insert = [
            ...
            'kode_tahap'=>$tahap,
            'tahun'=>$tahun,
            'target_fisik_akumulasi'=>$total_tft_ski,
            // 'target_fisik_akumulasi_ratarata'=>'',
            'target_fisik_bulanan'=>$total_tft_ski_bulanan,
            // 'target_fisik_bulanan_ratarata'=>'',
            'realisasi_fisik_akumulasi'=>$total_rft_ski,
            // 'realisasi_fisik_akumulasi_ratarata'=>'',
            'realisasi_fisik_bulanan'=>$total_rft_ski_bulanan,
            ...
            'target_keuangan_akumulasi'=>$persen_total_tk,
            // 'target_keuangan_akumulasi_ratarata'=>'',
            'target_keuangan_bulanan'=>$persen_total_tk_bulanan,
            // 'target_keuangan_bulanan_ratarata'=>'',
            'realisasi_keuangan_akumulasi'=>$persen_total_rk,
            // 'realisasi_keuangan_akumulasi_ratarata'=>'',
            'realisasi_keuangan_bulanan'=>$persen_total_rk_bulanan,
