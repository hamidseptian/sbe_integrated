...
class Laporan extends MY_Controller { 
 ...
 //    }
    ...
    // $id_instansi = 12;
        ...
        elseif ($kategori_penampilan_laporan=='rfk_berdasarkan_data_sumber_dana') {

	    // $program = $this->realisasi_akumulasi_model->get_program($id_instansi, $tahap, $tahun)->result();
	    // $program = $this->realisasi_akumulasi_model->get_program_berdasarkan_sumber_dana($id_instansi, $tahap, $tahun, $jenis_sumber_dana)->result();
	    $sub_kegiatan = $this->realisasi_akumulasi_model->get_sub_kegiatan_berdasarkan_sumber_dana_gabungan($id_instansi, $tahap, $tahun, $jenis_sumber_dana)->result();

	    $data['sub_kegiatan']=$sub_kegiatan;
	    $data['jenis_sumber_dana']=$jenis_sumber_dana	;
        	$judul_penampilan_laporan = "Laporan realisasi fisik dan keuangan berdasarkan Sumber Dana ".$jenis_sumber_dana." Per Sub Kegiatan";
		    // $html =  $this->load->view('laporan/pdf/realisasi_akumulasi/content_rfk_akumulasi_berdasarkan_sumber_dana', $data, true);
		    $html =  $this->load->view('laporan/pdf/realisasi_akumulasi/content_rfk_akumulasi_berdasarkan_sumber_dana_gabungan', $data, true);
        	$mpdf->SetMargins(0, 0, 39);
        }
 ...
 //         $data['judul_laporan']=$judul_penampilan_laporan;
	...
	public function pdf_laporan_realisasi_per_kab_kota()
	{
		...
		switch ($kategori) {
			case 'akumulasi':
				$ope = '<=';
				$judul_laporan = "Laporan realisasi Fisik dan Keuangan (RFK) ".$nama_tahap[$tahap]."<br>".$nama_kota."<br>sampai dengan bulan ".bulan_global($bulan).' '.$tahun;
				break;
			default:
				$ope = '=';
				$judul_laporan = "Laporan realisasi Fisik dan Keuangan (RFK) <br>".$nama_kota."<br>bulan ".bulan_global($bulan).' '.$tahun;
				break;
		}
...
// 		$excel->getActiveSheet()->getStyle('P'.$baris_mulai_paket)->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
  ...
  public function download_laporan_excel_realisasi_akumulasi(){
    // Load plugin PHPExcel nya
    include APPPATH.'third_party/PHPExcel/PHPExcel.php';
    $excel = new PHPExcel();
		$identitas = $this->db->get('identitas')->row_array();
    	...
    	$judul_konten = "Laporan Realisasi Fisik Dan Keuangan ";
...
// Untuk judulnya
	...
	$excel->getActiveSheet()->getStyle('A3')->getFont()->setSize(13);
		...
		$excel->getActiveSheet()->getStyle('A9:N12')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); 
	$excel->getActiveSheet()->getStyle('A9:N12')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER); 
	$excel->getActiveSheet()->getStyle('A9:N12')->getAlignment()->setWrapText(true); 

// Judul Laporan
	$excel->getActiveSheet()->mergeCells('A6:N6');
	$excel->getActiveSheet()->mergeCells('A7:N7');
	$excel->getActiveSheet()->getStyle('A6:A7')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); 
...
// settingan thead
	...
	$excel->getActiveSheet()->mergeCells('A9:A11');
	$excel->setActiveSheetIndex(0)->setCellValue('A9', "No");

	$excel->getActiveSheet()->mergeCells('B9:E10');
	$excel->setActiveSheetIndex(0)->setCellValue('B9', "Data APBD");
	...
	$excel->getActiveSheet()->mergeCells('F9:H9');
	$excel->setActiveSheetIndex(0)->setCellValue('F9', "Fisik");

	$excel->getActiveSheet()->mergeCells('I9:M9');
	$excel->setActiveSheetIndex(0)->setCellValue('I9', "Keuangan");

	$excel->getActiveSheet()->mergeCells('N9:N10');
	$excel->setActiveSheetIndex(0)->setCellValue('N9', "Sisa");
	
	$excel->setActiveSheetIndex(0)->setCellValue('B11', "Tahapan APBD");
	$excel->setActiveSheetIndex(0)->setCellValue('C11', "Kode Rekening");
	$excel->setActiveSheetIndex(0)->setCellValue('D11', "Uraian Program, Kegiatan, Sub Kegiatan");
	$excel->setActiveSheetIndex(0)->setCellValue('E11', "Pagu");
	
	$excel->setActiveSheetIndex(0)->setCellValue('F10', "Target");
	$excel->setActiveSheetIndex(0)->setCellValue('G10', "Realisasi");
	$excel->setActiveSheetIndex(0)->setCellValue('H10', "Deviasi");
	
	$excel->getActiveSheet()->mergeCells('I10:J10');
	$excel->setActiveSheetIndex(0)->setCellValue('I10', "Target");

	$excel->getActiveSheet()->mergeCells('K10:L10');
	$excel->setActiveSheetIndex(0)->setCellValue('K10', "Realisasi");
	
	$excel->setActiveSheetIndex(0)->setCellValue('M10', "Deviasi");
	...
	$excel->setActiveSheetIndex(0)->setCellValue('I11', "Rp");
	$excel->setActiveSheetIndex(0)->setCellValue('J11', "%");

	$excel->setActiveSheetIndex(0)->setCellValue('K11', "Rp");
	$excel->setActiveSheetIndex(0)->setCellValue('L11', "%");
	
	$excel->setActiveSheetIndex(0)->setCellValue('M11', "%");
	$excel->setActiveSheetIndex(0)->setCellValue('N11', "Rp");
	

	

	$excel->setActiveSheetIndex(0)->setCellValue('A12', "1");
	$excel->setActiveSheetIndex(0)->setCellValue('B12', "2");
	$excel->setActiveSheetIndex(0)->setCellValue('C12', "3");
	$excel->setActiveSheetIndex(0)->setCellValue('D12', "4");
	$excel->setActiveSheetIndex(0)->setCellValue('E12', "5");
	$excel->setActiveSheetIndex(0)->setCellValue('F12', "6");
	$excel->setActiveSheetIndex(0)->setCellValue('G12', "7");
	$excel->setActiveSheetIndex(0)->setCellValue('H12', "8");
	$excel->setActiveSheetIndex(0)->setCellValue('I12', "9");
	$excel->setActiveSheetIndex(0)->setCellValue('J12', "10");
	$excel->setActiveSheetIndex(0)->setCellValue('K12', "11");
	$excel->setActiveSheetIndex(0)->setCellValue('L12', "12");
	$excel->setActiveSheetIndex(0)->setCellValue('M12', "13");
	$excel->setActiveSheetIndex(0)->setCellValue('N12', "14");
	...
	$excel->getActiveSheet()->getColumnDimension('N')->setWidth(20);
		...
		$total_rp_rk_total = 0;
		$total_sub_kegiatan = 0 ;
		$total_persen_tk_total = 0;
		$total_persen_rk_total = 0;
		$sisa_pagu_total = 0 ; 




$total_peringatan_dev_fisik_merah_sub_kegiatan =0;
$total_peringatan_dev_fisik_kuning_sub_kegiatan =0;
$total_peringatan_dev_fisik_hijau_sub_kegiatan =0;
$total_peringatan_dev_keu_merah_sub_kegiatan =0;
$total_peringatan_dev_keu_kuning_sub_kegiatan =0;
$total_peringatan_dev_keu_hijau_sub_kegiatan =0;


$total_peringatan_dev_fisik_merah_kegiatan =0;
$total_peringatan_dev_fisik_kuning_kegiatan =0;
$total_peringatan_dev_fisik_hijau_kegiatan =0;
$total_peringatan_dev_keu_merah_kegiatan =0;
$total_peringatan_dev_keu_kuning_kegiatan =0;
$total_peringatan_dev_keu_hijau_kegiatan =0;


$total_peringatan_dev_fisik_merah_program =0;
$total_peringatan_dev_fisik_kuning_program =0;
$total_peringatan_dev_fisik_hijau_program =0;
$total_peringatan_dev_keu_merah_program =0;
$total_peringatan_dev_keu_kuning_program =0;
$total_peringatan_dev_keu_hijau_program =0;
...
$total_sub_kegiatan = 0 ; 
    ...
    // $pagu_program += $value->pagu;
				...
				foreach ($sub_kegiatan->result() as $key => $value_sk) {
					...
					if($kategori_sub_kegiatan =='Unit Pelaksana'){
			            ...
			            $nama_sub_kegiatan = $value_sk->nama_sub_kegiatan;
				          ...
				          // $dev_keu = $persen_realisasi_keuangan - $persen_target_keuangan;
				            ...
				            if ($dev_fisik < -10) {
				              $warna_peringatan_dev_fisik_sub_kegiatan = 'f8b2b2'; 
				              $total_peringatan_dev_fisik_merah_sub_kegiatan += 1; 
				            }
				            elseif ($dev_fisik <-5  && $dev_fisik >-10) {
				              $warna_peringatan_dev_fisik_sub_kegiatan = 'fcf3cf';
				              $total_peringatan_dev_fisik_kuning_sub_kegiatan += 1; 
				            }else{
				              $warna_peringatan_dev_fisik_sub_kegiatan = 'd5f5e3';
				              $total_peringatan_dev_fisik_hijau_sub_kegiatan += 1; 
				            }

				            if ($dev_keu < -10) {
				              $warna_peringatan_dev_keu_sub_kegiatan = 'f8b2b2'; 
				              $total_peringatan_dev_keu_merah_sub_kegiatan += 1; 
				            }
				            elseif ($dev_keu <-5  && $dev_keu >-10) {
				              $warna_peringatan_dev_keu_sub_kegiatan = 'fcf3cf';
				              $total_peringatan_dev_keu_kuning_sub_kegiatan += 1; 
				            }else{
				              $warna_peringatan_dev_keu_sub_kegiatan = 'd5f5e3';
				              $total_peringatan_dev_keu_hijau_sub_kegiatan += 1; 
				            }
			        	...
			        	$nilai_rp_realisasi_keuangan = $realisasi_keuangan['total_realisasi'] == '' ? 0 : $realisasi_keuangan['total_realisasi'] ;
			        	$nilai_rp_target_keuangan = $target_keuangan == '' ? 0 : $target_keuangan ;


				        	$pagu_total += $value_sk->pagu;
							$total_tf_total += $target_fisik;
							$total_rf_total += $total_realisasi_fisik;
							$total_rp_tk_total += $nilai_rp_target_keuangan;
							$total_rp_rk_total += $nilai_rp_realisasi_keuangan;
							$total_persen_tk_total += $persen_target_keuangan;
							$total_persen_rk_total += $persen_realisasi_keuangan;
			           ...
			           $data_kumpul_sub_kegiatan = [
						...
						'nilai_tk_sub_kegiatan'=> $nilai_rp_target_keuangan,
						'persen_tk_sub_kegiatan'=> $persen_target_keuangan,
						'nilai_rk_sub_kegiatan'=> $nilai_rp_realisasi_keuangan,
						'persen_rk_sub_kegiatan'=> $persen_realisasi_keuangan,
						'persen_dk_sub_kegiatan'=> $dev_keu,
						'warna_df_sub_kegiatan'=> $warna_peringatan_dev_fisik_sub_kegiatan,
						'warna_dk_sub_kegiatan'=> $warna_peringatan_dev_keu_sub_kegiatan,
						'sisa_anggaran_sub_kegiatan'=> $sisa_pagu,
				         ...
				         $total_tf_kegiatan += $target_fisik;
				         $total_rf_kegiatan += $total_realisasi_fisik;


				        $total_rp_tk_kegiatan += $nilai_rp_target_keuangan ; 
						$total_rp_rk_kegiatan += $nilai_rp_realisasi_keuangan ; 
				} // end foreach ($sub_kegiatan->result() as $key => $value_sk) 



						$persen_tf_kegiatan = $total_tf_kegiatan / count($kumpul_sub_kegiatan);
						$persen_rf_kegiatan = $total_rf_kegiatan / count($kumpul_sub_kegiatan);
						$persen_df_kegiatan = $persen_rf_kegiatan - $persen_tf_kegiatan;

						$persen_tk_kegiatan = ($total_rp_tk_kegiatan / $pagu_kegiatan) * 100 ;
						$persen_rk_kegiatan = ($total_rp_rk_kegiatan / $pagu_kegiatan) * 100 ;
						$persen_dk_kegiatan = $persen_rk_kegiatan - $persen_tk_kegiatan ;

						$sisa_anggaran_kegiatan = $pagu_kegiatan - $total_rp_rk_kegiatan;
						   ...
						   if ($persen_df_kegiatan < -10) {
				              $warna_peringatan_persen_df_kegiatan = 'f8b2b2'; 
				              $total_peringatan_dev_fisik_merah_kegiatan += 1; 
				            }
				            elseif ($persen_df_kegiatan <-5  && $persen_df_kegiatan >-10) {
				              $warna_peringatan_persen_df_kegiatan = 'fcf3cf';
				              $total_peringatan_dev_fisik_kuning_kegiatan += 1; 
				            }else{
				              $warna_peringatan_persen_df_kegiatan = 'd5f5e3';
				              $total_peringatan_dev_fisik_hijau_kegiatan += 1; 
				            }

				            if ($persen_dk_kegiatan < -10) {
				              $warna_peringatan_persen_dk_kegiatan = 'f8b2b2'; 
				              $total_peringatan_dev_keu_merah_kegiatan += 1; 
				            }
				            elseif ($persen_dk_kegiatan <-5  && $persen_dk_kegiatan >-10) {
				              $warna_peringatan_persen_dk_kegiatan = 'fcf3cf';
				              $total_peringatan_dev_keu_kuning_kegiatan += 1; 
				            }else{
				              $warna_peringatan_persen_dk_kegiatan = 'd5f5e3';
				              $total_peringatan_dev_keu_hijau_kegiatan += 1; 
				            }
				    ...
				    $data_kegiatan = [
			          ...
			          'pagu_kegiatan'=> $pagu_kegiatan,
						...
						'persen_tf_kegiatan'=> $persen_tf_kegiatan,
						'persen_rf_kegiatan'=> $persen_rf_kegiatan,
						'persen_df_kegiatan'=> $persen_df_kegiatan,
						'nilai_tk_kegiatan'=> $total_rp_tk_kegiatan,
						'persen_tk_kegiatan'=> $persen_tk_kegiatan,
						'nilai_rk_kegiatan'=> $total_rp_rk_kegiatan,
						'persen_rk_kegiatan'=> $persen_rk_kegiatan,
						'persen_dk_kegiatan'=> $persen_dk_kegiatan,
						'warna_df_kegiatan'=> $warna_peringatan_persen_df_kegiatan,
						'warna_dk_kegiatan'=> $warna_peringatan_persen_dk_kegiatan,
						'sisa_anggaran_kegiatan'=> $sisa_anggaran_kegiatan,
			       ...
			       $pagu_program += $pagu_kegiatan ; 
				         ...
				         $total_tf_program += $persen_tf_kegiatan;
				         $total_rf_program += $persen_rf_kegiatan;


				        $total_rp_tk_program += $total_rp_tk_kegiatan ; 
						$total_rp_rk_program += $total_rp_rk_kegiatan ; 


			} // foreach ($program as $key => $value_program)


					$persen_tf_program = $total_tf_program / count($kumpul_kegiatan);
					$persen_rf_program = $total_rf_program / count($kumpul_kegiatan);
					$persen_df_program = $persen_rf_program - $persen_tf_program;

					$persen_tk_program = ($total_rp_tk_program / $pagu_program) * 100 ;
					$persen_rk_program = ($total_rp_rk_program / $pagu_program) * 100 ;
					$persen_dk_program = $persen_rk_program - $persen_tk_program ;

					$sisa_anggaran_program = $pagu_program - $total_rp_rk_program;





						   if ($persen_df_program < -10) {
				              $warna_peringatan_persen_df_program = 'f8b2b2'; 
				              $total_peringatan_dev_fisik_merah_program += 1; 
				            }
				            elseif ($persen_df_program <-5  && $persen_df_program >-10) {
				              $warna_peringatan_persen_df_program = 'fcf3cf';
				              $total_peringatan_dev_fisik_kuning_program += 1; 
				            }else{
				              $warna_peringatan_persen_df_program = 'd5f5e3';
				              $total_peringatan_dev_fisik_hijau_program += 1; 
				            }

				            if ($persen_dk_program < -10) {
				              $warna_peringatan_persen_dk_program = 'f8b2b2'; 
				              $total_peringatan_dev_keu_merah_program += 1; 
				            }
				            elseif ($persen_dk_program <-5  && $persen_dk_program >-10) {
				              $warna_peringatan_persen_dk_program = 'fcf3cf';
				              $total_peringatan_dev_keu_kuning_program += 1; 
				            }else{
				              $warna_peringatan_persen_dk_program = 'd5f5e3';
				              $total_peringatan_dev_keu_hijau_program += 1; 
				            }
	    	...
	    	$row_program++;
	    	 ...
	    	 $data_program = [
	          ...
	          'pagu_program'=> $pagu_program,
				...
				'persen_tf_program'=> $persen_tf_program,
				'persen_rf_program'=> $persen_rf_program,
				'persen_df_program'=> $persen_df_program,
				'nilai_tk_program'=> $total_rp_tk_program,
				'persen_tk_program'=> $persen_tk_program,
				'nilai_rk_program'=> $total_rp_rk_program,
				'persen_rk_program'=> $persen_rk_program,
				'persen_dk_program'=> $persen_dk_program,
				'warna_df_program'=> $warna_peringatan_persen_df_program,
				'warna_dk_program'=> $warna_peringatan_persen_dk_program,
				'sisa_anggaran_program'=> $sisa_anggaran_program,
		...
		foreach ($kumpul_program as $k_program => $v_program) { 
     	 	...
     	 	$excel->getActiveSheet()->getStyle('A'.$row_program.':N'.$row_program)->applyFromArray($fill_program);
	    	$excel->getActiveSheet()->getStyle('A'.$row_program)->applyFromArray($border);
	    	$excel->getActiveSheet()->getStyle('B'.$row_program)->applyFromArray($border);
	    	$excel->getActiveSheet()->getStyle('C'.$row_program)->applyFromArray($border);
	    	$excel->getActiveSheet()->getStyle('D'.$row_program)->applyFromArray($border);
	    	...
	    	$excel->getActiveSheet()->getStyle('N'.$row_program)->applyFromArray($border);
      		...
      		$excel->getActiveSheet()->getStyle('A'.$row_program.':N'.$row_program)->getAlignment()->setWrapText(true); 
      		$excel->getActiveSheet()->getStyle('A'.$row_program.':N'.$row_program)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_TOP);
      // 		$excel->getActiveSheet()->getStyle('A'.$row_program.':AR'.$row_program)->applyFromArray($fill_program);
	     	...
	     	$excel->setActiveSheetIndex(0)->setCellValue('C'.$row_program, $v_program['kode_rekening_program']); 
	     	$excel->setActiveSheetIndex(0)->setCellValue('D'.$row_program, $v_program['nama_program']); 
			$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_program, $v_program['pagu_program']); 
      		$excel->getActiveSheet()->getStyle('E'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 
	     	




			$excel->setActiveSheetIndex(0)->setCellValue('F'.$row_program,  round($v_program['persen_tf_program'],2)); 
			$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_program,  round($v_program['persen_rf_program'],2)); 
			$excel->setActiveSheetIndex(0)->setCellValue('H'.$row_program,  round($v_program['persen_df_program'],2)); 

			$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_program, $v_program['nilai_tk_program']); 
      		$excel->getActiveSheet()->getStyle('I'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 
			$excel->setActiveSheetIndex(0)->setCellValue('J'.$row_program, round($v_program['persen_tk_program'],2)); 
			$excel->setActiveSheetIndex(0)->setCellValue('K'.$row_program, $v_program['nilai_rk_program']); 
      		$excel->getActiveSheet()->getStyle('K'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 
			$excel->setActiveSheetIndex(0)->setCellValue('L'.$row_program, round($v_program['persen_rk_program'],2)); 
			$excel->setActiveSheetIndex(0)->setCellValue('M'.$row_program, round($v_program['persen_dk_program'],2)); 
			$excel->setActiveSheetIndex(0)->setCellValue('N'.$row_program, $v_program['sisa_anggaran_program']); 
      		$excel->getActiveSheet()->getStyle('N'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 
		    ...
		    $excel->getActiveSheet()->getStyle('E'.$row_program.':U'.$row_program)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
		      		 ...
		      		 $fill_df_program = array(
					        'fill' => array(
					            'type' => PHPExcel_Style_Fill::FILL_SOLID,
					            'color' => array('rgb' => $v_program['warna_df_program'])
					        )
					    );

		      		 $fill_dk_program = array(
					        'fill' => array(
					            'type' => PHPExcel_Style_Fill::FILL_SOLID,
					            'color' => array('rgb' => $v_program['warna_dk_program'])
					        )
					    );


	 	     	 	$excel->getActiveSheet()->getStyle('H'.$row_program)->applyFromArray($fill_df_program);
	 	     	 	$excel->getActiveSheet()->getStyle('M'.$row_program)->applyFromArray($fill_dk_program);
	     	 ...
	     	 foreach ($v_program['data_kegiatan'] as $k_kegiatan => $v_kegiatan) { 
		     	$row_program++;
	     	 	...
	     	 	$excel->getActiveSheet()->getStyle('A'.$row_program.':N'.$row_program)->applyFromArray($fill_kegiatan);
				...
				$excel->setActiveSheetIndex(0)->setCellValue('C'.$row_program, $v_kegiatan['kode_rekening_kegiatan']); 
				$excel->setActiveSheetIndex(0)->setCellValue('D'.$row_program, $v_kegiatan['nama_kegiatan']); 
				$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_program, $v_kegiatan['pagu_kegiatan']); 

		      		$excel->getActiveSheet()->getStyle('E'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 


					$excel->setActiveSheetIndex(0)->setCellValue('F'.$row_program,  round($v_kegiatan['persen_tf_kegiatan'],2)); 
					$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_program,  round($v_kegiatan['persen_rf_kegiatan'],2)); 
					$excel->setActiveSheetIndex(0)->setCellValue('H'.$row_program,  round($v_kegiatan['persen_df_kegiatan'],2)); 

					$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_program, $v_kegiatan['nilai_tk_kegiatan']); 
		      		$excel->getActiveSheet()->getStyle('I'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 
					$excel->setActiveSheetIndex(0)->setCellValue('J'.$row_program, round($v_kegiatan['persen_tk_kegiatan'],2)); 
					$excel->setActiveSheetIndex(0)->setCellValue('K'.$row_program, $v_kegiatan['nilai_rk_kegiatan']); 
		      		$excel->getActiveSheet()->getStyle('K'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 
					$excel->setActiveSheetIndex(0)->setCellValue('L'.$row_program, round($v_kegiatan['persen_rk_kegiatan'],2)); 
					$excel->setActiveSheetIndex(0)->setCellValue('M'.$row_program, round($v_kegiatan['persen_dk_kegiatan'],2)); 
					$excel->setActiveSheetIndex(0)->setCellValue('N'.$row_program, $v_kegiatan['sisa_anggaran_kegiatan']); 
		      		$excel->getActiveSheet()->getStyle('N'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 



		      		 $fill_df_kegiatan = array(
					        'fill' => array(
					            'type' => PHPExcel_Style_Fill::FILL_SOLID,
					            'color' => array('rgb' => $v_kegiatan['warna_df_kegiatan'])
					        )
					    );

		      		 $fill_dk_kegiatan = array(
					        'fill' => array(
					            'type' => PHPExcel_Style_Fill::FILL_SOLID,
					            'color' => array('rgb' => $v_kegiatan['warna_dk_kegiatan'])
					        )
					    );


	 	     	 	$excel->getActiveSheet()->getStyle('H'.$row_program)->applyFromArray($fill_df_kegiatan);
	 	     	 	$excel->getActiveSheet()->getStyle('M'.$row_program)->applyFromArray($fill_dk_kegiatan);
				...
				foreach ($v_kegiatan['data_sub_kegiatan'] as $k_ski => $v_sub_kegiatan) { 
					...
					$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_program, $v_sub_kegiatan['pagu_sub_kegiatan']); 
		      		$excel->getActiveSheet()->getStyle('E'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 

					$excel->setActiveSheetIndex(0)->setCellValue('F'.$row_program,  round($v_sub_kegiatan['persen_tf_sub_kegiatan'],2)); 
					$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_program,  round($v_sub_kegiatan['persen_rf_sub_kegiatan'],2)); 
					$excel->setActiveSheetIndex(0)->setCellValue('H'.$row_program,  round($v_sub_kegiatan['persen_df_sub_kegiatan'],2)); 

					$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_program, $v_sub_kegiatan['nilai_tk_sub_kegiatan']); 
		      		$excel->getActiveSheet()->getStyle('I'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 
					$excel->setActiveSheetIndex(0)->setCellValue('J'.$row_program, round($v_sub_kegiatan['persen_tk_sub_kegiatan'],2)); 
					$excel->setActiveSheetIndex(0)->setCellValue('K'.$row_program, $v_sub_kegiatan['nilai_rk_sub_kegiatan']); 
		      		$excel->getActiveSheet()->getStyle('K'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 
					$excel->setActiveSheetIndex(0)->setCellValue('L'.$row_program, round($v_sub_kegiatan['persen_rk_sub_kegiatan'],2)); 
					$excel->setActiveSheetIndex(0)->setCellValue('M'.$row_program, round($v_sub_kegiatan['persen_dk_sub_kegiatan'],2)); 
					$excel->setActiveSheetIndex(0)->setCellValue('N'.$row_program, $v_sub_kegiatan['sisa_anggaran_sub_kegiatan']); 
		      		$excel->getActiveSheet()->getStyle('N'.$row_program)->getNumberFormat()->setFormatCode('#,##0'); 



		      		 $fill_df_sub_kegiatan = array(
					        'fill' => array(
					            'type' => PHPExcel_Style_Fill::FILL_SOLID,
					            'color' => array('rgb' => $v_sub_kegiatan['warna_df_sub_kegiatan'])
					        )
					    );

		      		 $fill_dk_sub_kegiatan = array(
					        'fill' => array(
					            'type' => PHPExcel_Style_Fill::FILL_SOLID,
					            'color' => array('rgb' => $v_sub_kegiatan['warna_dk_sub_kegiatan'])
					        )
					    );


	 	     	 	$excel->getActiveSheet()->getStyle('H'.$row_program)->applyFromArray($fill_df_sub_kegiatan);
	 	     	 	$excel->getActiveSheet()->getStyle('M'.$row_program)->applyFromArray($fill_dk_sub_kegiatan);
		...
		$row_total = $row_program;
		$row_pencapaian = $row_program+1;


	$excel->getActiveSheet()->mergeCells('A'.$row_total.':D'.$row_total);
	$excel->setActiveSheetIndex(0)->setCellValue('A'.$row_total, "Total");

	$excel->getActiveSheet()->getStyle('A'.$row_total)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT); 
	$excel->getActiveSheet()->getStyle('A'.$row_pencapaian)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT); 

	$excel->getActiveSheet()->mergeCells('A'.$row_pencapaian.':D'.$row_pencapaian);
	$excel->setActiveSheetIndex(0)->setCellValue('A'.$row_pencapaian, "Pencapaian");
...
$pencapaian_tf = $total_tf_total /  $total_sub_kegiatan ; 
$pencapaian_rf = $total_rf_total / $total_sub_kegiatan; 
$pencapaian_df = $pencapaian_rf - $pencapaian_tf ; 

$pencapaian_tk = ($total_rp_tk_total / $pagu_total) * 100 ; 
$pencapaian_rk = ($total_rp_rk_total / $pagu_total) * 100 ; 
$pencapaian_dk = $pencapaian_rk - $pencapaian_tk ; 
$sisa_anggaran_total = $pagu_total - $total_rp_rk_total;
   ...
   if ($pencapaian_df < -10) {
      $warna_peringatan_pencapaian_df = 'f8b2b2'; 
    }
    elseif ($pencapaian_df <-5  && $pencapaian_df >-10) {
      $warna_peringatan_pencapaian_df = 'fcf3cf';
    }else{
      $warna_peringatan_pencapaian_df = 'd5f5e3';
    }

    if ($pencapaian_dk < -10) {
      $warna_peringatan_pencapaian_dk = 'f8b2b2'; 
    }
    elseif ($pencapaian_dk <-5  && $pencapaian_dk >-10) {
      $warna_peringatan_pencapaian_dk = 'fcf3cf'; 
    }else{
      $warna_peringatan_pencapaian_dk = 'd5f5e3'; 
    }



		      		 $fill_df_pencapaian = array(
					        'fill' => array(
					            'type' => PHPExcel_Style_Fill::FILL_SOLID,
					            'color' => array('rgb' => $warna_peringatan_pencapaian_df)
					        )
					    );

		      		 $fill_dk_pencapaian = array(
					        'fill' => array(
					            'type' => PHPExcel_Style_Fill::FILL_SOLID,
					            'color' => array('rgb' => $warna_peringatan_pencapaian_dk)
					        )
					    );


	 	     	 	$excel->getActiveSheet()->getStyle('H'.$row_pencapaian)->applyFromArray($fill_df_pencapaian);
	 	     	 	$excel->getActiveSheet()->getStyle('M'.$row_pencapaian)->applyFromArray($fill_dk_pencapaian);



	$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_total, $pagu_total);
	$excel->getActiveSheet()->getStyle('E'.$row_total)->getNumberFormat()->setFormatCode('#,##0'); 
	$excel->setActiveSheetIndex(0)->setCellValue('F'.$row_total, $total_tf_total);
	$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_total, $total_rf_total);
	$excel->setActiveSheetIndex(0)->setCellValue('H'.$row_total, "--");
	$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_total, $total_rp_tk_total);
	$excel->getActiveSheet()->getStyle('I'.$row_total)->getNumberFormat()->setFormatCode('#,##0'); 
	$excel->setActiveSheetIndex(0)->setCellValue('J'.$row_total, $total_persen_tk_total);
	$excel->setActiveSheetIndex(0)->setCellValue('K'.$row_total, $total_rp_rk_total);
	$excel->getActiveSheet()->getStyle('K'.$row_total)->getNumberFormat()->setFormatCode('#,##0'); 
	$excel->setActiveSheetIndex(0)->setCellValue('L'.$row_total, $total_persen_rk_total);
	$excel->setActiveSheetIndex(0)->setCellValue('M'.$row_total, "-");
	$excel->setActiveSheetIndex(0)->setCellValue('N'.$row_total, $sisa_pagu_total);
	$excel->getActiveSheet()->getStyle('N'.$row_total)->getNumberFormat()->setFormatCode('#,##0'); 


	$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_pencapaian, "--");
	$excel->setActiveSheetIndex(0)->setCellValue('F'.$row_pencapaian, round($pencapaian_tf,2));
	$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_pencapaian, round($pencapaian_rf,2));
	$excel->setActiveSheetIndex(0)->setCellValue('H'.$row_pencapaian, round($pencapaian_df,2));


	$excel->getActiveSheet()->mergeCells('I'.$row_pencapaian.':J'.$row_pencapaian);
	$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_pencapaian, round($pencapaian_tk,2));
	$excel->getActiveSheet()->mergeCells('K'.$row_pencapaian.':L'.$row_pencapaian);
	$excel->setActiveSheetIndex(0)->setCellValue('K'.$row_pencapaian, round($pencapaian_rk,2));
	$excel->setActiveSheetIndex(0)->setCellValue('M'.$row_pencapaian, round($pencapaian_dk,2));
	$excel->setActiveSheetIndex(0)->setCellValue('N'.$row_pencapaian, "--");


	$excel->getActiveSheet()->getStyle('E'.$row_pencapaian.':N'.$row_pencapaian)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); 



	$excel->getActiveSheet()->getStyle('A'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('B'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('C'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('D'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('E'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('F'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('G'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('H'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('I'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('J'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('K'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('L'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('M'.$row_total)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('N'.$row_total)->applyFromArray($border);

	$excel->getActiveSheet()->getStyle('A'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('B'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('C'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('D'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('E'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('F'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('G'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('H'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('I'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('J'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('K'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('L'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('M'.$row_pencapaian)->applyFromArray($border);
	$excel->getActiveSheet()->getStyle('N'.$row_pencapaian)->applyFromArray($border);
		...
		$row_statistika_header = $row_program+4;
		$row_statistika_data_apbd = $row_program+5;
		$row_statistika_realisasi = $row_program+6;
		$row_statistika_d_10 = $row_program+7;
		$row_statistika_d_5_10 = $row_program+8;
		$row_statistika_d_5 = $row_program+9;
		$row_statistika_total_data = $row_program+10;



		for ($i=$row_statistika_header; $i <= $row_statistika_total_data; $i++) { 
	...
	$excel->getActiveSheet()->mergeCells('B'.$row_statistika_header.':J'.$row_statistika_header);
	$excel->getActiveSheet()->getStyle('B'.$row_statistika_header.':J'.$row_statistika_header)->applyFromArray($border);
	$excel->setActiveSheetIndex(0)->setCellValue('B'.$row_statistika_header, "Statistika Deviasi");

	$excel->getActiveSheet()->mergeCells('B'.$row_statistika_data_apbd.':D'.$row_statistika_realisasi);
	$excel->setActiveSheetIndex(0)->setCellValue('B'.$row_statistika_data_apbd, "Keterangan");

	$excel->getActiveSheet()->mergeCells('E'.$row_statistika_data_apbd.':F'.$row_statistika_data_apbd);
	$excel->getActiveSheet()->mergeCells('G'.$row_statistika_data_apbd.':H'.$row_statistika_data_apbd);
	$excel->getActiveSheet()->mergeCells('I'.$row_statistika_data_apbd.':J'.$row_statistika_data_apbd);
	$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_statistika_data_apbd, "Program");
	$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_statistika_data_apbd, "Kegiatan");
	$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_statistika_data_apbd, "Sub Kegiatan");

	$excel->getActiveSheet()->mergeCells('B'.$row_statistika_d_10.':D'.$row_statistika_d_10);
	$excel->getActiveSheet()->mergeCells('B'.$row_statistika_d_5_10.':D'.$row_statistika_d_5_10);
	$excel->getActiveSheet()->mergeCells('B'.$row_statistika_d_5.':D'.$row_statistika_d_5);
	$excel->getActiveSheet()->mergeCells('B'.$row_statistika_total_data.':D'.$row_statistika_total_data);

	$excel->setActiveSheetIndex(0)->setCellValue('B'.$row_statistika_d_10, "Deviasi Diatas -10% ");
	$excel->setActiveSheetIndex(0)->setCellValue('B'.$row_statistika_d_5_10, "Deviasi Diantara -5% sampai -10% ");
	$excel->setActiveSheetIndex(0)->setCellValue('B'.$row_statistika_d_5, "Deviasi Dibawah -5% ");
	$excel->setActiveSheetIndex(0)->setCellValue('B'.$row_statistika_total_data, "Total Data");

	$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_statistika_realisasi, "Fisik");
	$excel->setActiveSheetIndex(0)->setCellValue('F'.$row_statistika_realisasi, "Keuangan");
	$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_statistika_realisasi, "Fisik");
	$excel->setActiveSheetIndex(0)->setCellValue('H'.$row_statistika_realisasi, "Keuangan");
	$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_statistika_realisasi, "Fisik");
	$excel->setActiveSheetIndex(0)->setCellValue('J'.$row_statistika_realisasi, "Keuangan");




 $fill_deviasi_hijau = array(
        'fill' => array(
            'type' => PHPExcel_Style_Fill::FILL_SOLID,
            'color' => array('rgb' => 'f8b2b2')
        )
    );
 $fill_deviasi_kuning = array(
        'fill' => array(
            'type' => PHPExcel_Style_Fill::FILL_SOLID,
            'color' => array('rgb' => 'fcf3cf')
        )
    );
 $fill_deviasi_merah = array(
        'fill' => array(
            'type' => PHPExcel_Style_Fill::FILL_SOLID,
...
$excel->getActiveSheet()->getStyle('B'.$row_statistika_header.':J'.$row_statistika_realisasi)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); 
$excel->getActiveSheet()->getStyle('E'.$row_statistika_d_10.':J'.$row_statistika_total_data)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); 





 	$excel->getActiveSheet()->getStyle('B'.$row_statistika_d_10.':J'.$row_statistika_d_10)->applyFromArray($fill_deviasi_hijau);
 	$excel->getActiveSheet()->getStyle('B'.$row_statistika_d_5_10.':J'.$row_statistika_d_5_10)->applyFromArray($fill_deviasi_kuning);
 	$excel->getActiveSheet()->getStyle('B'.$row_statistika_d_5.':J'.$row_statistika_d_5)->applyFromArray($fill_deviasi_merah);

	$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_statistika_d_10, $total_peringatan_dev_fisik_merah_sub_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_statistika_d_5_10, $total_peringatan_dev_fisik_kuning_sub_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_statistika_d_5, $total_peringatan_dev_fisik_hijau_sub_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('J'.$row_statistika_d_10, $total_peringatan_dev_keu_merah_sub_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('J'.$row_statistika_d_5_10, $total_peringatan_dev_keu_kuning_sub_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('J'.$row_statistika_d_5, $total_peringatan_dev_keu_hijau_sub_kegiatan);

	$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_statistika_d_10, $total_peringatan_dev_fisik_merah_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_statistika_d_5_10, $total_peringatan_dev_fisik_kuning_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_statistika_d_5, $total_peringatan_dev_fisik_hijau_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('H'.$row_statistika_d_10, $total_peringatan_dev_keu_merah_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('H'.$row_statistika_d_5_10, $total_peringatan_dev_keu_kuning_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('H'.$row_statistika_d_5, $total_peringatan_dev_keu_hijau_kegiatan);

	$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_statistika_d_10, $total_peringatan_dev_fisik_merah_program);
	$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_statistika_d_5_10, $total_peringatan_dev_fisik_kuning_program);
	$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_statistika_d_5, $total_peringatan_dev_fisik_hijau_program);
	$excel->setActiveSheetIndex(0)->setCellValue('F'.$row_statistika_d_10, $total_peringatan_dev_keu_merah_program);
	$excel->setActiveSheetIndex(0)->setCellValue('F'.$row_statistika_d_5_10, $total_peringatan_dev_keu_kuning_program);
	$excel->setActiveSheetIndex(0)->setCellValue('F'.$row_statistika_d_5, $total_peringatan_dev_keu_hijau_program);


	$excel->getActiveSheet()->mergeCells('E'.$row_statistika_total_data.':F'.$row_statistika_total_data);
	$excel->getActiveSheet()->mergeCells('G'.$row_statistika_total_data.':H'.$row_statistika_total_data);
	$excel->getActiveSheet()->mergeCells('I'.$row_statistika_total_data.':J'.$row_statistika_total_data);
	$excel->setActiveSheetIndex(0)->setCellValue('E'.$row_statistika_total_data, $total_program);
	$excel->setActiveSheetIndex(0)->setCellValue('G'.$row_statistika_total_data, $total_kegiatan);
	$excel->setActiveSheetIndex(0)->setCellValue('I'.$row_statistika_total_data, $total_sub_kegiatan);
