...
$pagu_bo = $this->realisasi_akumulasi_model->total_pagu_sub_kegiatan($value_sk->kode_rekening_sub_kegiatan, $tahap, $id_instansi, 'pagu_bo')->row_array()['pagu_bo'];
        ...
        $realisasi_dipilih = $keuangan->cek_realisasi_dipilih($value_sk->kode_rekening_sub_kegiatan, $tahap, $id_instansi)->row_array();
                ...
                $realisasi_bo = $keuangan->total_realisasi_perjenis($value_sk->kode_rekening_sub_kegiatan, $tahap, $id_instansi, 'realisasikan_bo', $ope)->row_array()['realisasi_bo'];
                $realisasi_bm = $keuangan->total_realisasi_perjenis($value_sk->kode_rekening_sub_kegiatan, $tahap, $id_instansi, 'realisasikan_bm', $ope)->row_array()['realisasi_bm'];
                $realisasi_btt = $keuangan->total_realisasi_perjenis($value_sk->kode_rekening_sub_kegiatan, $tahap, $id_instansi, 'realisasikan_btt', $ope)->row_array()['realisasi_btt'];
                $realisasi_bt = $keuangan->total_realisasi_perjenis($value_sk->kode_rekening_sub_kegiatan, $tahap, $id_instansi, 'realisasikan_bt', $ope)->row_array()['realisasi_bt'];
