...
sum(btt) as realisasi_btt,
 ...
 sum(bo_bp + bo_bbj+ bo_bs+bo_bh + bm_bmt + bm_bmpm + bm_bmgb + bm_bmjji + bm_bmatl +btt +  bt_bbh+bt_bbk ) as total
    ...
    public function cek_realisasi_dipilih($tahun_anggaran, $tahap, $id_instansi)
    {
        $bulan  = date('n');
        $query  = $this->db->query("SELECT
    ...
    public function total_realisasi_perjenis($bulan_aktif, $tahun_anggaran, $tahap, $id_instansi, $jenis)
    {
