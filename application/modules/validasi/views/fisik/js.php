...
<script>
	...
	function info_validasi_skpd(id_instansi, tahun='<?php echo tahun_anggaran() ?>'){
		$.ajax({
				...
				$.each(data.evidence, function(k, v) {
					...
					if (data.data.id_group=='5') {
						if (v.auto_evidence==1) {
							...
							var tombol_action = '<button class="btn btn-primary btn-xs" onclick="lihat_evidence_auto('+ "'"+v.file_dokumen+ "','"+data.data.nama_paket+ "','"+v.dokumen+ "'"+ ')" class="btn btn-info btn-xs" data-toggle="tooltip" title="upload ulang evidence" target="_blank"><i class=" fa fa-folder-open"></i></button> <button class="btn btn-danger btn-xs" data-toggle="tooltip" title="Lihat Evidence evidence" target="_blank" onclick="Swal.fire('+"'warning','Dokumen "+v.dokumen+" tidak bisa di update karena terintegrasi dengan SIPEDAL','error'" + ')"><i class="metismenu-icon fas fa-file-signature"></i></button>';
						...
						if (v.auto_evidence==1) {
							...
							var tombol_action = '<button class="btn btn-primary btn-xs" onclick="lihat_evidence_auto('+ "'"+v.file_dokumen+ "','"+data.data.nama_paket+ "','"+v.dokumen+ "'"+ ')" class="btn btn-info btn-xs" data-toggle="tooltip" title="upload ulang evidence" target="_blank"><i class=" fa fa-folder-open"></i></button>';
	...
	function show_table_swakelola(id_instansi, tahun='<?php echo tahun_anggaran() ?>') {
	...
	function show_table_penyedia(id_instansi, tahun='<?php echo tahun_anggaran() ?>') {
	...
	function show_table_belum_validasi(id_instansi, tahun='<?php echo tahun_anggaran() ?>') {
	...
	function show_table_evidence_ditolak(id_instansi, tahun='<?php echo tahun_anggaran() ?>') {
	...
	function show_statistika(id_instansi, tahun='<?php echo tahun_anggaran() ?>') {
		$.ajax({
			url: baseUrl('validasi/statistika/'),
			type: "POST",
			dataType: "JSON",
